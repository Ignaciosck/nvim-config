	...
	config = function()
		...
		local keybindings = {
			...
			t = {
				...
				d = { "<cmd>Telescope diagnostics<CR>", "Diagnosticos" },
			},
			q = { "<cmd>q<CR>", "Cerrar" },
			...
			["g"] = {
				...
				name = "Git&LSP",
				D = { "<cmd>lua vim.lsp.buf.declaration()<CR>", "Declaración LSP" },
				d = { "<cmd>lua vim.lsp.buf.definition()<CR>", "Definición LSP" },
				p = {
					name = "Peek",
				...
				i = { "<cmd>lua vim.lsp.buf.implementation()<CR>", "Implementación" },
				R = { "<cmd>Lspsaga finder tyd+ref+def<CR>", "Referencias" },
				...
				o = { "<cmd>Lspsaga outline<CR>", "Git: Etapa de fragmento" },
				-- f2 = {},
			},
		}
